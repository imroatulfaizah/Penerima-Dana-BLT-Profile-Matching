			...
			<div class="container-fluid">
				...
				<div class="card mb-3">
					<div class="card-header">
						...
						Data Kriteria penilaian | <a href="<?php echo site_url('admin/add_aspek') ?>"><i class='fas fa-plus'></i>Tambah</a></div>
					<div class="card-body">
						<div class="table-responsive">
							<table class="table table-sm table-striped table-hover" id="dataTable" width="100%" cellspacing="0">
								<thead class="thead-inverse text-center">
									<tr>
										<th class="">Kode Kriteria penilaian</th>
										<th class="">Nama Kriteria penilaian</th>
										<th class="">Bobot (%)</th>
										<th class="">Aksi</th>
									</tr>
								</thead>
