								...
								<tbody>
									...
									<tr class="text-center">
										...
										<td class="text-center">
                                            <a href="<?php echo site_url('admin/edit_user/'.$tampil->id) ?>" class="btn btn-small"><i class="fas fa-edit"></i> Edit</a> 
                                            <a onclick="deleteConfirm('<?php echo site_url('admin/delete_user/'.$tampil->id) ?>')" href="#!" class="btn btn-small text-danger"><i class="fas fa-trash"></i> Hapus</a>
                                        </td>
                                    </tr>
                                    <?php } ?>
								</tbody>
