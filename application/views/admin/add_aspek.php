					...
					<div class="card-body">
						...
						<!-- ================= -->
							...
							<div class="form-group">
								<label for="">Kode Kriteria penilaian</label>
								...
								<small id="helpId" class="form-text text-muted">Masukkan Kode Kriteria</small>
						...
						<!-- ================= -->
							...
							<div class="form-group">
								<label for="">Nama Kriteria penilaian</label>
								...
								<small id="emailHelpId" class="form-text text-muted">Masukkan Nama Kriteria</small>
								<div class="invalid-feedback">
